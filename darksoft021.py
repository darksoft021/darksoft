...
def consult_CEP():
    def consult_cep():
        os.system("clear")
        print("\033[1;31mSeja bem vindo Painel by:@darksoft$ | 666 ¿🇧🇷021\033[0m")
...
def consult_IP():
    def consult_ip():
        os.system('clear')
        print('\033[01;35mSeja Bem Vindo Consulta IP By:@darksoft$ | 666 ¿🇧🇷021')
        print('\033[01;36m=========================================')
        ip = input('\033[01;34m>>> ')
        return ip
...
def options_consult():
    while True:
        os.system("clear")
        print("\033[1;31mSeja bem vindo Painel by:@darksoft$ | 666 ¿🇧🇷021\033[0m"), print("\033[1;33m--------------------------------------\033[0m\n")
